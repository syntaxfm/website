    ...
    <Page>
      ...
      <div className="wrapper wrapper--text">
        ...
        <p>
          ...
          development podcasts out there (we think it's the most listened to!).
          If you think our audience may be a good fit, let's chat about how we
          can make this sponsorship worth it for you.
        </p>
        ...
        <p>
          ...
          independent full stack developers who create online training courses.
          In each episode, Scott and Wes break down topics to provide{' '}
          <em>"Tasty Treats"</em> to the audience — applicable tips and nuggets
          of information to help web developers in their careers.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Premium products — Scott and Wes have a weekly "Sick Pick", which is
            a product or service that they have been enjoying lately
          </li>
        </ul>
        ...
        <p>
          DevLifts is now sponsoring multiple episodes and will be using Syntax
          as an ongoing revenue and leads source.
        </p>
