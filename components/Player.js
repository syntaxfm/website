...
export default class Player extends React.Component {
    ...
    scrub = e => {
        const scrubTime =
            (e.nativeEvent.offsetX / this.progress.offsetWidth) *
            this.audio.duration;
        ...
        switch (type) {
            case "decrease":
                playbackRate = parseFloat(
                    (this.state.playbackRate - 0.1).toFixed(2)
                );
                if (playbackRate <= 0) {
                    ...
                    <div className="player__volume">
                        ...
                        <div className="player__inputs">
                            <input
                                ...
                                id="vol10"
                                checked={
                                    this.state.volume === 0.1 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol10">
                            ...
                            <input
                                ...
                                id="vol20"
                                checked={
                                    this.state.volume === 0.2 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol20">
                            ...
                            <input
                                ...
                                id="vol30"
                                checked={
                                    this.state.volume === 0.3 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol30">
                            ...
                            <input
                                ...
                                id="vol40"
                                checked={
                                    this.state.volume === 0.4 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol40">
                            ...
                            <input
                                ...
                                id="vol50"
                                checked={
                                    this.state.volume === 0.5 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol50">
                            ...
                            <input
                                ...
                                id="vol60"
                                checked={
                                    this.state.volume === 0.6 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol60">
                            ...
                            <input
                                ...
                                id="vol70"
                                checked={
                                    this.state.volume === 0.7 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol70">
                            ...
                            <input
                                ...
                                id="vol80"
                                checked={
                                    this.state.volume === 0.8 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol80">
                            ...
                            <input
                                ...
                                id="vol90"
                                checked={
                                    this.state.volume === 0.9 ? true : false
                                }
                                className="sr-only"
                            />
                            <label htmlFor="vol90">
