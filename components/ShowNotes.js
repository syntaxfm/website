...
export default ({ show, setCurrentPlaying }) =>
  <div className="showNotes">
    ...
    <a className="button" href={`https://github.com/wesbos/Syntax/edit/master/${show.notesFile}`} target='_blank' rel="noopener noreferrer"><span className="icon">✏️</span> Edit Show Notes</a>
