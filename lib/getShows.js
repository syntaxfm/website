...
const loadShows = async () => {
  ...
  shows = showMarkdown
    ...
    .map((show, i) => {
      // sometimes the meta comes back as a number, sometimes a string?!
      const number =
        typeof show.meta.number === 'number'
          ? show.meta.number
          : parseFloat(show.meta.number.toString(8));

      return Object.assign({}, show.meta, {
        html: show.html,
        notesFile: files[i],
