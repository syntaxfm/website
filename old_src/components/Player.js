...
export default class Player extends React.Component {
	constructor(props) {
		...
		if (typeof window !== 'undefined') {
			...
			if (lastPlayback) lastPlaybackRate = JSON.parse(lastPlayback).lastPlaybackRate; //eslint-disable-line
		}
	...
	scrubTime = (eventData) =>
		(eventData.nativeEvent.offsetX / this.progress.offsetWidth) * this.audio.duration;
